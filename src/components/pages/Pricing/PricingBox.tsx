const PricingBox = (props: {
  ...
  return (
    <div className='w-full'>
      <div className='shadow-three hover:shadow-one dark:shadow-two relative z-10 rounded-sm bg-white px-8 py-10 dark:bg-gray-dark dark:hover:shadow-gray-dark'>
