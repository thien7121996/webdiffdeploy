  ...
  return (
    <div className='relative flex'>
      ...
      <div
        ...
        className={`border-stroke absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border bg-white p-1.5 shadow-default dark:border-strokedark dark:bg-boxdark ${
